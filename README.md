...
3.  Yeni paket versiyonları yayınlamak için yeni bir Git etiketi oluşturun (örn: `git tag v1.8.0` ve `git push origin v1.8.0`). Release pipeline'ı gerisini halleder.

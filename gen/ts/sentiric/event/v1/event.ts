...
export interface MediaGenerationCompletedEvent {
...
function createBaseMediaGenerationCompletedEvent(): MediaGenerationCompletedEvent {
  return {
    eventType: "",
    traceId: "",
    jobId: "",
...
export const MediaGenerationCompletedEvent: MessageFns<MediaGenerationCompletedEvent> = {
  encode(message: MediaGenerationCompletedEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.eventType !== "") {
      writer.uint32(10).string(message.eventType);
    }
    if (message.traceId !== "") {
    ...
    if (message.resultUri !== "") {
      writer.uint32(58).string(message.resultUri);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MediaGenerationCompletedEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMediaGenerationCompletedEvent();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 7: {
          ...
          message.resultUri = reader.string();
          continue;
        }
        case 8: {
          if (tag !== 66) {
  ...
  fromJSON(object: any): MediaGenerationCompletedEvent {
    return {
      eventType: isSet(object.eventType)
        ? globalThis.String(object.eventType)
        : isSet(object.event_type)
      ...
      resultUri: isSet(object.resultUri)
        ? globalThis.String(object.resultUri)
        : isSet(object.result_uri)
        ? globalThis.String(object.result_uri)
        : "",
  ...
  toJSON(message: MediaGenerationCompletedEvent): unknown {
    const obj: any = {};
    if (message.eventType !== "") {
      obj.eventType = message.eventType;
    }
    ...
    if (message.resultUri !== "") {
      obj.resultUri = message.resultUri;
    }
    if (message.errorMessage !== "") {
  ...
  create<I extends Exact<DeepPartial<MediaGenerationCompletedEvent>, I>>(base?: I): MediaGenerationCompletedEvent {
    return MediaGenerationCompletedEvent.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MediaGenerationCompletedEvent>, I>>(
    object: I,
    ...
    message.resultUri = object.resultUri ?? "";

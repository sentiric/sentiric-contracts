...
mediaInfoMap: (f = msg.getMediaInfoMap()) ? f.toObject(includeInstance, undefined) : []
  };
...
proto.sentiric.event.v1.CallStartedEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getMediaInfoMap(true);
  if (f && f.getLength() > 0) {
jspb.internal.public_for_gencode.serializeMapToBinary(
    message.getMediaInfoMap(true),
    8,
    writer,
 ...
 */
proto.sentiric.event.v1.CallStartedEvent.prototype.getMediaInfoMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.sentiric.event.v1.CallStartedEvent} returns this
 */
proto.sentiric.event.v1.CallStartedEvent.prototype.clearMediaInfoMap = function() {
  this.getMediaInfoMap().clear();
  return this;
};

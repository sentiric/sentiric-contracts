...
func (x *TranscribeStreamResponse) GetGenderProxy() string {
	if x != nil {
...
func (x *TranscribeStreamResponse) GetEmotionProxy() string {
	if x != nil {
...
func (x *TranscribeStreamResponse) GetArousal() float32 {
	if x != nil {
		return x.Arousal
	}
	return 0
...
func (x *TranscribeStreamResponse) GetValence() float32 {
	if x != nil {
		return x.Valence
	}
	return 0

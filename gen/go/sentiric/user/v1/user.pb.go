...
type Tenant struct {
	...
	PrimaryLanguageCode string                 `protobuf:"bytes,4,opt,name=primary_language_code,json=primaryLanguageCode,proto3" json:"primary_language_code,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *Tenant) GetPrimaryLanguageCode() string {
	if x != nil {

...
const file_sentiric_dialplan_v1_dialplan_proto_rawDesc = "" +
	...
	"\x0fmatched_contact\x18\x05 \x01(\v2\x19.sentiric.user.v1.ContactH\x01R\x0ematchedContact\x88\x01\x01B\x0f\n" +
	"\r_matched_userB\x12\n" +
...
var file_sentiric_dialplan_v1_dialplan_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_sentiric_dialplan_v1_dialplan_proto_goTypes = []any{
	...
	nil,                             // 4: sentiric.dialplan.v1.ActionData.DataEntry
	(*v1.User)(nil),                 // 5: sentiric.user.v1.User
	(*v1.Contact)(nil),              // 6: sentiric.user.v1.Contact
}
var file_sentiric_dialplan_v1_dialplan_proto_depIdxs = []int32{
	4, // 0: sentiric.dialplan.v1.ActionData.data:type_name -> sentiric.dialplan.v1.ActionData.DataEntry
	...
	5, // 3: sentiric.dialplan.v1.ResolveDialplanResponse.matched_user:type_name -> sentiric.user.v1.User
	6, // 4: sentiric.dialplan.v1.ResolveDialplanResponse.matched_contact:type_name -> sentiric.user.v1.Contact
	0, // 5: sentiric.dialplan.v1.DialplanService.ResolveDialplan:input_type -> sentiric.dialplan.v1.ResolveDialplanRequest
	3, // 6: sentiric.dialplan.v1.DialplanService.ResolveDialplan:output_type -> sentiric.dialplan.v1.ResolveDialplanResponse

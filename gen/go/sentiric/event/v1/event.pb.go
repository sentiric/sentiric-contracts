...
type GenericEvent struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	EventType string                 `protobuf:"bytes,1,opt,name=event_type,json=eventType,proto3" json:"event_type,omitempty"` // Örn: "user.created", "dialplan.updated"
	TraceId   string                 `protobuf:"bytes,2,opt,name=trace_id,json=traceId,proto3" json:"trace_id,omitempty"`
...
func (x *GenericEvent) Reset() {
	*x = GenericEvent{}
	mi := &file_sentiric_event_v1_event_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenericEvent) Descriptor() ([]byte, []int) {
	return file_sentiric_event_v1_event_proto_rawDescGZIP(), []int{5}
}
...
func (x *GenericEvent) GetTraceId() string {
	if x != nil {
		return x.TraceId
	}
	return ""
...
func (x *GenericEvent) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *GenericEvent) GetTenantId() string {
	if x != nil {
		return x.TenantId
	}
	return ""
...
func (x *GenericEvent) GetPayloadJson() string {
	if x != nil {

        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sentiric.external.v1.ConnectorService",
                        "ExecuteAction",
                    ),
                );
...
pub mod connector_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sentiric.external.v1.ConnectorService/ExecuteAction" => {
                    ...
                    struct ExecuteActionSvc<T: ConnectorService>(pub Arc<T>);
                    impl<
                        T: ConnectorService,
                    ...
                    for ExecuteActionSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ConnectorService>::execute_action(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T: ConnectorService> tonic::server::NamedService for ConnectorServiceServer<T> {
        const NAME: &'static str = "sentiric.external.v1.ConnectorService";
    }
}
/// Generated client implementations.
pub mod marketplace_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn list_recipes(
            ...
            tonic::Response<super::ListRecipesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sentiric.external.v1.MarketplaceService",
                        "ListRecipes",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        pub async fn install_recipe(
            &mut self,
            request: impl tonic::IntoRequest<super::InstallRecipeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InstallRecipeResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod marketplace_service_server {
    ...
    pub trait MarketplaceService: Send + Sync + 'static {
        ...
        async fn install_recipe(
            &self,
            request: tonic::Request<super::InstallRecipeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InstallRecipeResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sentiric.external.v1.MarketplaceService/ListRecipes" => {
                    #[allow(non_camel_case_types)]
                    struct ListRecipesSvc<T: MarketplaceService>(pub Arc<T>);
                    impl<
                        T: MarketplaceService,
                    > tonic::server::UnaryService<super::ListRecipesRequest>
                    for ListRecipesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketplaceService>::list_recipes(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/sentiric.external.v1.MarketplaceService/InstallRecipe" => {
                    #[allow(non_camel_case_types)]
                    struct InstallRecipeSvc<T: MarketplaceService>(pub Arc<T>);
                    impl<
                        T: MarketplaceService,
                    > tonic::server::UnaryService<super::InstallRecipeRequest>
                    for InstallRecipeSvc<T> {
                        type Response = super::InstallRecipeResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MarketplaceService>::install_recipe(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InstallRecipeSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    for MarketplaceServiceServer<T> {
        const NAME: &'static str = "sentiric.external.v1.MarketplaceService";
    }
}
/// Generated client implementations.
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sentiric.external.v1.NotificationService",
                        "SendSMS",
                    ),
                );
            self.inner.unary(req, path, codec).await
        ...
        pub async fn send_email(
            &mut self,
            request: impl tonic::IntoRequest<super::SendEmailRequest>,
        ) -> std::result::Result<
...
pub mod notification_service_server {
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sentiric.external.v1.NotificationService/SendSMS" => {
                    #[allow(non_camel_case_types)]
                    struct SendSMSSvc<T: NotificationService>(pub Arc<T>);
                    impl<
                        T: NotificationService,
                    ...
                    for SendSMSSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotificationService>::send_sms(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/sentiric.external.v1.NotificationService/SendEmail" => {
                    #[allow(non_camel_case_types)]
                    struct SendEmailSvc<T: NotificationService>(pub Arc<T>);
                    impl<
                        T: NotificationService,
                    > tonic::server::UnaryService<super::SendEmailRequest>
                    for SendEmailSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NotificationService>::send_email(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T: NotificationService> tonic::server::NamedService
    for NotificationServiceServer<T> {
        const NAME: &'static str = "sentiric.external.v1.NotificationService";
    }
}
/// Generated client implementations.
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sentiric.external.v1.PaymentService",
                        "InitiatePayment",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod payment_service_server {
    ...
    impl<T: PaymentService> tonic::server::NamedService for PaymentServiceServer<T> {
        const NAME: &'static str = "sentiric.external.v1.PaymentService";
    }
}
/// Generated client implementations.
pub mod scheduling_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn create_appointment(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateAppointmentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateAppointmentResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sentiric.external.v1.SchedulingService",
                        "CreateAppointment",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod scheduling_service_server {
    ...
    pub trait SchedulingService: Send + Sync + 'static {
        async fn create_appointment(
            &self,
            request: tonic::Request<super::CreateAppointmentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateAppointmentResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sentiric.external.v1.SchedulingService/CreateAppointment" => {
                    #[allow(non_camel_case_types)]
                    struct CreateAppointmentSvc<T: SchedulingService>(pub Arc<T>);
                    impl<
                        T: SchedulingService,
                    > tonic::server::UnaryService<super::CreateAppointmentRequest>
                    for CreateAppointmentSvc<T> {
                        type Response = super::CreateAppointmentResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SchedulingService>::create_appointment(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateAppointmentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    for SchedulingServiceServer<T> {
        const NAME: &'static str = "sentiric.external.v1.SchedulingService";
    }
}

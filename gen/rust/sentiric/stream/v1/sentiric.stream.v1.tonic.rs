        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn stream_session(
            ...
            request: impl tonic::IntoStreamingRequest<
                Message = super::StreamSessionRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::StreamSessionResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod stream_gateway_service_server {
    ...
    pub trait StreamGatewayService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn stream_session(
            &self,
            request: tonic::Request<tonic::Streaming<super::StreamSessionRequest>>,
        ) -> std::result::Result<
                    ...
                    for StreamSessionSvc<T> {
                        ...
                        fn call(
                            ...
                            request: tonic::Request<
                                tonic::Streaming<super::StreamSessionRequest>,
                            >,
                        ) -> Self::Future {

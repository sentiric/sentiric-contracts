...
pub mod billing_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn process_usage(
            &mut self,
            request: impl tonic::IntoRequest<super::ProcessUsageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ProcessUsageResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sentiric.billing.v1.BillingService", "ProcessUsage"),
                );
...
pub mod billing_service_server {
    ...
    pub trait BillingService: std::marker::Send + std::marker::Sync + 'static {
        async fn process_usage(
            &self,
            request: tonic::Request<super::ProcessUsageRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ProcessUsageResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sentiric.billing.v1.BillingService/ProcessUsage" => {
                    ...
                    struct ProcessUsageSvc<T: BillingService>(pub Arc<T>);
                    impl<
                        T: BillingService,
                    > tonic::server::UnaryService<super::ProcessUsageRequest>
                    for ProcessUsageSvc<T> {
                        type Response = super::ProcessUsageResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as BillingService>::process_usage(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = ProcessUsageSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
    ...
    pub const SERVICE_NAME: &str = "sentiric.billing.v1.BillingService";

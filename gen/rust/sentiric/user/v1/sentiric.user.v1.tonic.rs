...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_sip_credentials(
            &mut self,
            request: impl tonic::IntoRequest<super::GetSipCredentialsRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sentiric.user.v1.UserService", "GetSipCredentials"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod user_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/sentiric.user.v1.UserService/GetSipCredentials" => {
                    #[allow(non_camel_case_types)]
                    struct GetSipCredentialsSvc<T: UserService>(pub Arc<T>);
                    impl<
                        T: UserService,
                    > tonic::server::UnaryService<super::GetSipCredentialsRequest>
                    for GetSipCredentialsSvc<T> {
                        type Response = super::GetSipCredentialsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as UserService>::get_sip_credentials(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "sentiric.user.v1.UserService";
...
pub mod identity_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sentiric.user.v1.IdentityService", "Authenticate"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn authorize_token(
            &mut self,
            request: impl tonic::IntoRequest<super::AuthorizeTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AuthorizeTokenResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sentiric.user.v1.IdentityService", "AuthorizeToken"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod identity_service_server {
    ...
    pub trait IdentityService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn authorize_token(
            &self,
            request: tonic::Request<super::AuthorizeTokenRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AuthorizeTokenResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/sentiric.user.v1.IdentityService/AuthorizeToken" => {
                    #[allow(non_camel_case_types)]
                    struct AuthorizeTokenSvc<T: IdentityService>(pub Arc<T>);
                    impl<
                        T: IdentityService,
                    > tonic::server::UnaryService<super::AuthorizeTokenRequest>
                    for AuthorizeTokenSvc<T> {
                        type Response = super::AuthorizeTokenResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IdentityService>::authorize_token(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AuthorizeTokenSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sentiric.user.v1.IdentityService";

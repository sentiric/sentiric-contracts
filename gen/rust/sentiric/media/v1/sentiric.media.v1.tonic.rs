...
pub mod media_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn allocate_port(
            &mut self,
            request: impl tonic::IntoRequest<super::AllocatePortRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AllocatePortResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sentiric.media.v1.MediaService", "AllocatePort"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn release_port(
            &mut self,
            request: impl tonic::IntoRequest<super::ReleasePortRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sentiric.media.v1.MediaService", "ReleasePort"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod media_service_server {
    ...
    pub trait MediaService: std::marker::Send + std::marker::Sync + 'static {
        async fn allocate_port(
            &self,
            request: tonic::Request<super::AllocatePortRequest>,
        ) -> std::result::Result<
            tonic::Response<super::AllocatePortResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sentiric.media.v1.MediaService/AllocatePort" => {
                    ...
                    struct AllocatePortSvc<T: MediaService>(pub Arc<T>);
                    impl<
                        T: MediaService,
                    > tonic::server::UnaryService<super::AllocatePortRequest>
                    for AllocatePortSvc<T> {
                        type Response = super::AllocatePortResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as MediaService>::allocate_port(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = AllocatePortSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                ...
                "/sentiric.media.v1.MediaService/ReleasePort" => {
                    #[allow(non_camel_case_types)]
                    struct ReleasePortSvc<T: MediaService>(pub Arc<T>);
                    impl<
                        T: MediaService,
                    > tonic::server::UnaryService<super::ReleasePortRequest>
                    for ReleasePortSvc<T> {
                        type Response = super::ReleasePortResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MediaService>::release_port(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "sentiric.media.v1.MediaService";

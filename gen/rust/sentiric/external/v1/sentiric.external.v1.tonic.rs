...
pub mod connector_service_server {
    ...
    pub const SERVICE_NAME: &str = "sentiric.external.v1.ConnectorService";
...
pub mod marketplace_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sentiric.external.v1.MarketplaceService";
...
pub mod notification_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sentiric.external.v1.NotificationService";
...
pub mod payment_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sentiric.external.v1.PaymentService";
...
pub mod scheduling_service_server {
    ...
    #[async_trait]
    pub trait SchedulingService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct SchedulingServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> SchedulingServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for SchedulingServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sentiric.external.v1.SchedulingService";
    impl<T> tonic::server::NamedService for SchedulingServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}

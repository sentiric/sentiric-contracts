...
pub mod license_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn verify_feature(
            &mut self,
            request: impl tonic::IntoRequest<super::VerifyFeatureRequest>,
        ) -> std::result::Result<
            tonic::Response<super::VerifyFeatureResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sentiric.control.v1.LicenseService",
                        "VerifyFeature",
                    ),
                );
...
pub mod license_service_server {
    ...
    pub trait LicenseService: Send + Sync + 'static {
        async fn verify_feature(
            &self,
            request: tonic::Request<super::VerifyFeatureRequest>,
        ) -> std::result::Result<
            tonic::Response<super::VerifyFeatureResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sentiric.control.v1.LicenseService/VerifyFeature" => {
                    ...
                    struct VerifyFeatureSvc<T: LicenseService>(pub Arc<T>);
                    impl<
                        T: LicenseService,
                    > tonic::server::UnaryService<super::VerifyFeatureRequest>
                    for VerifyFeatureSvc<T> {
                        type Response = super::VerifyFeatureResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as LicenseService>::verify_feature(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = VerifyFeatureSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
    ...
    impl<T: LicenseService> tonic::server::NamedService for LicenseServiceServer<T> {
        const NAME: &'static str = "sentiric.control.v1.LicenseService";
    }
}
/// Generated client implementations.
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sentiric.control.v1.ObservabilityService",
                        "GetMetrics",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod observability_service_server {
    ...
    #[derive(Debug)]
    pub struct ObservabilityServiceServer<T: ObservabilityService> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: ObservabilityService> ObservabilityServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/sentiric.control.v1.ObservabilityService/GetMetrics" => {
                    #[allow(non_camel_case_types)]
                    struct GetMetricsSvc<T: ObservabilityService>(pub Arc<T>);
                    impl<
                        T: ObservabilityService,
                    ...
                    for GetMetricsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ObservabilityService>::get_metrics(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/sentiric.control.v1.ObservabilityService/GetLogs" => {
                    #[allow(non_camel_case_types)]
                    struct GetLogsSvc<T: ObservabilityService>(pub Arc<T>);
                    impl<
                        T: ObservabilityService,
                    ...
                    for GetLogsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ObservabilityService>::get_logs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T: ObservabilityService> Clone for ObservabilityServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: ObservabilityService> tonic::server::NamedService
    for ObservabilityServiceServer<T> {
        const NAME: &'static str = "sentiric.control.v1.ObservabilityService";
    }
}
/// Generated client implementations.
pub mod task_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("sentiric.control.v1.TaskService", "DispatchTask"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod task_service_server {
    ...
    impl<T: TaskService> tonic::server::NamedService for TaskServiceServer<T> {
        const NAME: &'static str = "sentiric.control.v1.TaskService";
    }
}

...
pub mod ecommerce_service_server {
    ...
    #[async_trait]
    pub trait EcommerceService: Send + Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct EcommerceServiceServer<T: EcommerceService> {
        inner: Arc<T>,
    ...
    impl<T: EcommerceService> EcommerceServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T: EcommerceService> Clone for EcommerceServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: EcommerceService> tonic::server::NamedService for EcommerceServiceServer<T> {
        const NAME: &'static str = "sentiric.vertical.v1.EcommerceService";
    }
}
/// Generated client implementations.
...
pub mod finance_service_server {
    ...
    #[async_trait]
    pub trait FinanceService: Send + Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct FinanceServiceServer<T: FinanceService> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: FinanceService> FinanceServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T: FinanceService> Clone for FinanceServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: FinanceService> tonic::server::NamedService for FinanceServiceServer<T> {
        const NAME: &'static str = "sentiric.vertical.v1.FinanceService";
    }
}
/// Generated client implementations.
...
pub mod health_service_server {
    ...
    impl<T: HealthService> tonic::server::NamedService for HealthServiceServer<T> {
        const NAME: &'static str = "sentiric.vertical.v1.HealthService";
    }
}
/// Generated client implementations.
...
pub mod hospitality_service_server {
    ...
    #[async_trait]
    pub trait HospitalityService: Send + Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct HospitalityServiceServer<T: HospitalityService> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: HospitalityService> HospitalityServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T: HospitalityService> Clone for HospitalityServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: HospitalityService> tonic::server::NamedService
    for HospitalityServiceServer<T> {
        const NAME: &'static str = "sentiric.vertical.v1.HospitalityService";
    }
}
/// Generated client implementations.
...
pub mod legal_service_server {
    ...
    #[async_trait]
    pub trait LegalService: Send + Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct LegalServiceServer<T: LegalService> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T: LegalService> LegalServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T: LegalService> Clone for LegalServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: LegalService> tonic::server::NamedService for LegalServiceServer<T> {
        const NAME: &'static str = "sentiric.vertical.v1.LegalService";
    }
}
/// Generated client implementations.
...
pub mod public_service_server {
    ...
    impl<T: PublicService> tonic::server::NamedService for PublicServiceServer<T> {
        const NAME: &'static str = "sentiric.vertical.v1.PublicService";
    }
}
